						    ...
						    if(isset($_POST['ppchange']))
						      {
						        ...
						        if($err=="")
						          {
						            $sql = "SELECT * FROM admin WHERE username= '".$_SESSION['adminuser']."' AND password='".$opp."'";
						               $result = mysqli_query($con,$sql);
						            if(mysqli_num_rows($result)>0)
						              {
						              	$query="UPDATE admin SET password='".$npp."' WHERE username= '".$_SESSION['adminuser']."' AND password='".$opp."'";
					...
					<form action="" method="POST">
						<table class="table ">
							...
							<tr>
								...
								<th > <input type="text" name="npp" autocomplete="off" minlength="5" maxlength="20"> </th>
								
							</tr>
							<tr>
								<th >Conform New Password: </th>
								<th ><input type="text" name="cpp" autocomplete="off" minlength="5" maxlength="20"> </th>
							</tr>
							<tr>
